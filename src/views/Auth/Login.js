  ...
  async function handleAuthForm(values) {
    ...
    try {
      ...
      if (data.login.success) {
        updateSelf({
          uid: data.login.data.user.id,
          type: "USER",
          picture: data.login.data.user.avatar,
          username: data.login.data.user.username,
          email: data.login.data.user.email,
          name:
            data.login.data.user.firstName + " " + data.login.data.user.lastName
        });
